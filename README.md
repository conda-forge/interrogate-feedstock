...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/interrogate-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9972&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/interrogate-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `interrogate` can be installed with:

```
conda install interrogate
```

It is possible to list all of the versions of `interrogate` available on your platform with:
